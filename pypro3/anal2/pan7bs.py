...
<div id="hello">
    ...
    <a href="https://www.mbc.net">mbc</a>
    <span>
    <a href="https://www.tvn.net">tvn</a>
    </span>
</div>
<span>
    <a href="https://www.mbc.net">mbc</a>
...
<div id="hi" class="good">
    second div
    <a href="https://www.ytn.net">ytn</a>
</div>
</body>
</html>
"""
soup4 = BeautifulSoup(html_page4, 'lxml')
aa = soup4.select_one("div") # 단순 선택
print(aa)
print('---')
...
print(ee)
ff = soup4.selectO("ul.world > li") # .은class #은 id
for k in ff:
    print("li : ",k.string)
